...
export default async function Image() {
  ...
  const BACKGROUND_GRADIENT_END = "#10b981";   // Emerald
...
*/
  return new ImageResponse(
    (
      ...
      >
        <h1 tw="text-8xl text-center font-semibold tracking-tight">{PROJECT_TITLE}</h1>
        <h3 tw="text-3xl font-normal mt-8 max-w-4xl text-center opacity-90">{PROJECT_DESCRIPTION}</h3>
      </div>
    ),
    options
  );
